  ...
  class MyDateTest extends PHPUnit_Framework_TestCase {
      ...
      public function __construct() {
          ...
          require_once("../../../application/custom/MyDate.php");
          $this->myDate = new MyDate();
      }



    public function testIsItLeapYear() {

        $isLeap = $this->myDate->isItLeapYear('2016');
        $this->assertEquals(true, $isLeap);
    }

      public function testIsInvert() {

          $invert = $this->myDate->isItInvert(-98);
